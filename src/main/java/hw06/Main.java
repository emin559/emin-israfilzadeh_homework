...
public class Main {
  public static void main(String[] args) {
    ...
    schedule[0][0] = Human.DayOfWeek.Monday.name();
    schedule[0][1] = "do home work";
    schedule[1][0] = Human.DayOfWeek.Tuesday.name();
    schedule[1][1] = "go to courses";
    schedule[2][0] = Human.DayOfWeek.Wednesday.name();
    schedule[2][1] = "watch a film";
    schedule[3][0] = Human.DayOfWeek.Thursday.name();
    schedule[3][1] = "go for a walk";
    schedule[4][0] = Human.DayOfWeek.Friday.name();
    schedule[4][1] = "meet with friends";
    schedule[5][0] = Human.DayOfWeek.Saturday.name();
    schedule[5][1] = "play football";
    schedule[6][0] = Human.DayOfWeek.Sunday.name();
    ...
    Pet qwerty = new Pet(Pet.Species.Dog, "qwerty", 1, 55, qwertyHabits);
